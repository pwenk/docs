...
<AccordionGroup>
  <Accordion title="1. Food & Feeling Journal (3 days)">
    Use this tracking sheet to document everything for 3 days. No changes to your diet yet - just observation.

    **Access:** [Daily Tracking Sheet (Google Sheets)](https://docs.google.com/spreadsheets/d/1Ux123WIVtTadMS_IGJbp7guxJxYkOfKY8knZZbxJO-g/edit?gid=0#gid=0)

    Make a copy of this sheet (File → Make a copy) so you can edit it.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Daily Tracking Sheet" icon="table" href="https://docs.google.com/spreadsheets/d/1Ux123WIVtTadMS_IGJbp7guxJxYkOfKY8knZZbxJO-g/edit?gid=0#gid=0">
