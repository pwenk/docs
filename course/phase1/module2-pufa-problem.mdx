...
<CardGroup cols={2}>
  ...
  <Card title="PUFA Database (Online)" icon="globe" href="/resources/pufa-database.html">
    Browser-based searchable version
  </Card>
</CardGroup>
...
Can't find a specific food in the database? You have two quick options:

1. **Google it:** Search "[food name] PUFA content" or "[food name] omega-6"
2. **Ask ChatGPT:** "How much PUFA is in [food]?" or "Does [product] contain seed oils?"

Both will give you a quick answer. The high-level principle from this module is what matters most—eliminate industrial seed oils, not obsess over every trace amount.
</Info>
