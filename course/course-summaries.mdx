...
<CardGroup cols={3}>
  <Card title="Just Starting?" icon="flag" href="phase1/module1-take-stock">
    Begin with Module 1: Take Stock
  </Card>

  <Card title="Mid-Course?" icon="flask" href="phase2/module4-reading-body">
    Jump to Phase 2: Experimentation
  </Card>

  <Card title="Need Maintenance?" icon="rotate" href="phase3/module12-long-term-maintenance">
...
<Card title="Back to Course Overview" icon="arrow-left" href="overview">
