...
<AccordionGroup>
  <Accordion title="1. Assess Your Metabolic Readiness">
    ...
    **Download:** [Metabolic Readiness Assessment](#)
  </Accordion>
  ...
  <Accordion title="2. Calculate Your Minimums">
    ...
    **Download:** [GLP-1 Nutrition Calculator](#)
  </Accordion>
  ...
  <Accordion title="3. Design Your Strength Training Plan">
    ...
    **Don't have a plan? Use ours.**

    **Download:** [GLP-1 Muscle Protection Training Plan](#)
  </Accordion>

  <Accordion title="4. Set Up Body Signal Tracking">
    **Download the tracking sheet and commit to weekly monitoring:**
    ...
    **Download:** [GLP-1 Body Signal Tracker](#)
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Metabolic Readiness Assessment" icon="clipboard-check" href="/resources/metabolic-readiness-assessment.pdf">
    Self-assessment to determine if you're ready for GLP-1s
  </Card>

  <Card title="GLP-1 Nutrition Calculator" icon="calculator" href="/resources/glp1-nutrition-calculator.pdf">
    Calculate your minimum protein, carbs, and calories
  </Card>

  <Card title="Muscle Protection Training Plan" icon="dumbbell" href="/resources/glp1-training-plan.pdf">
    3-4 day strength training program to preserve muscle
  </Card>

  <Card title="GLP-1 Body Signal Tracker" icon="chart-line" href="/resources/glp1-body-signal-tracker.pdf">
    Weekly tracking sheet for temp, pulse, energy, weight
  </Card>
</CardGroup>
