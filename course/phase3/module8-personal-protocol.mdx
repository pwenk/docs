...
<CardGroup cols={2}>
  <Card title="Personal Protocol Template" icon="file-lines">
    Build your customized eating framework
  </Card>

  <Card title="Experiment Results Analyzer" icon="chart-bar">
    Review and synthesize your experiments
  </Card>

  <Card title="'My Rules' Document" icon="list-check">
    Your non-negotiables and flexibility rules
  </Card>

  <Card title="Adjustment Guide" icon="sliders">
    When and how to modify your protocol
  </Card>
</CardGroup>
