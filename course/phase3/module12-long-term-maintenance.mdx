...
Life will throw disruptions at you—travel, holidays, illness, major stress, injury. The key is knowing how to recover quickly.

**Recovery basics:**
- Don't panic (one week off won't undo months of work)
- Return to basics (eliminate seed oils, eat enough carbs, track temperature)
- Give it 1-2 weeks to feel normal again
- Learn from it (what triggered the slip? how can you prepare better?)
- Move forward (the next meal is a new opportunity)
...
Want to go deeper? Module 13 explores the anti-dogma mindset and why questioning everything (including this course) matters.

<Card title="Continue to Module 13 (Bonus)" icon="arrow-right" href="/course/phase3/module13-anti-dogma">
  Explore the anti-dogma philosophy
</Card>
