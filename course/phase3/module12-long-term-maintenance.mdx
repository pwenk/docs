...
<CardGroup cols={3}>
  <Card title="Maintenance Protocol" icon="clipboard">
    Your sustainable long-term structure
  </Card>

  <Card title="'When Life Happens' Guide" icon="heart-pulse">
    How to recover from disruptions
  </Card>

  <Card title="Long-Term Check-In Schedule" icon="calendar-days">
    Quarterly review template
  </Card>
</CardGroup>
