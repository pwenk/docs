...
<Steps>
  ...
  <Step title="Worst Case: Grocery Store">
    Buy yogurt, cheese, fruit, milk, pre-cooked rice.

    Not glamorous, but works, honey.
  </Step>
</Steps>
...
<Steps>
  <Step title="Review: Restaurant Strategies">
    Review the restaurant guide in this module - safest restaurant types and what to order.
  </Step>

  <Step title="Prepare: What to Say Scripts">
    Review the conversation scripts in this module for different social situations.
  </Step>

  <Step title="Plan: Travel Prep">
    Review the packing list and travel strategies in this module.
  </Step>
...
In **Module 10**, you'll learn about supplements - what actually matters (very little) and what doesn't (most of it), sugar.
...
<CardGroup cols={3}>
  ...
  <Card title="Social Scripts" icon="comments" href="/course/bonus/social-scripts">
    What to say when people ask - responses for 8 common scenarios by relationship type
  </Card>
