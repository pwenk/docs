...
### Copy-Paste Daily Assessment Template

**Instead of a PDF, use your existing apps!** Copy this template into your favorite reminder or notes app:

<CodeGroup>
```text Daily Check-In Template
HOW DO I FEEL? - Daily Check-In

PHYSICAL:
- Energy level (1-10):
- Body temperature (feel warm/cold):
- Digestion (good/bloated/other):
...
<Info>
**Recommended Apps for Daily Check-Ins:**

**Best Overall:**
- **Daylio** (iOS/Android) - One-tap mood tracking with daily reminders and pattern charts
- **How We Feel** (iOS/Android) - Completely free nonprofit app with guided reflections

**Great Alternatives:**
- **Moodflow** (iOS/Android) - Free mood and activity tracker with pattern recognition
- **Reflectly** (iOS/Android) - AI-powered journaling with daily prompts
- **Apple Reminders** (iOS) - Simple, built-in, no install needed
- **Apple Notes** (iOS) - Quick capture with reminder options

All these apps have daily reminder features so you never forget to check in!
</Info>
...
### Main Download:
<Card title="Body Signal Tracking Sheet (PDF)" icon="clipboard-list" href="#">
  30-day printable tracker for temperature, pulse, energy, and digestion
</Card>

### Bonus Resources:
<CardGroup cols={2}>
  <Card title="Temperature & Pulse Guide" icon="thermometer" href="/course/bonus/temperature-pulse-guide">
    Reference ranges, interpretations, and troubleshooting
  </Card>
...
<Note>
**The "How Do I Feel?" Assessment** is now available as a copy-paste template above (no PDF needed). Just copy it into your favorite tracking app!
</Note>
