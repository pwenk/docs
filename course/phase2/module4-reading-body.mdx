...
<Steps>
  ...
  <Step title="Record the Numbers">
    Log temps daily in your notes app or tracker (see template below).
  </Step>
...
### Tracking Template:
The "How Do I Feel?" daily check-in template is provided above in this module (no PDF needed). Just copy it into your favorite tracking app!
