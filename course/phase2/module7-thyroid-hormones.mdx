...
<Steps>
  <Step title="Read: Thyroid Function One-Pager">
    Quick reference on thyroid basics - all covered in this module
  </Step>

  <Step title="Understand: Why Keto Killed My Thyroid">
    Review the "Why Low-Carb Destroys Thyroid" section above
  </Step>

  <Step title="Review: Thyroid Support Foods">
    See the nutrition tabs in "How to Support Thyroid Naturally" section above
  </Step>
</Steps>
