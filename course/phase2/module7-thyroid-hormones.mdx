...
<CardGroup cols={3}>
  <Card title="Thyroid Function One-Pager" icon="file-lines">
    Quick reference guide
  </Card>

  <Card title="Why Keto Killed My Thyroid" icon="book">
    Low-carb thyroid damage explainer
  </Card>

  <Card title="Thyroid Support Food List" icon="list">
    Foods rich in thyroid nutrients
  </Card>
</CardGroup>
