...
### Main Download:
<Card title="Experiment Tracker Template (PDF)" icon="clipboard-list" href="#">
  Log your experiments and results - track what works for YOUR body
</Card>

### Bonus Resources:
<Card title="Complete Experiment Library" icon="flask" href="/course/bonus/experiment-library">
  All 20 experiments organized by difficulty (Easy, Medium, Hard) with detailed instructions, tracking guidance, troubleshooting, and how to create custom experiments
</Card>

<Note>
The **Experiment Library bonus page** includes everything: all 20 experiments, results analysis guidance, and the custom experiment designer framework - all in one comprehensive resource.
</Note>
